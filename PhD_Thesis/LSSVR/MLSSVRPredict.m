function [predictY, TSE, R2]= MLSSVRPredict(tstX, tstY, trnX, alpha, b, p)
% 
% [predictY, TSE, R2]= MLSSVRPredict(tstX, tstY, trnX, alpha, b, p);  
% 
...
predictY = repmat(sum(K*alpha, 2), 1, m) + repmat(b', tstN, 1); 
